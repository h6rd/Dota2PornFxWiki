...
## Запуск Workshop Tools на Linux

### 1. Включение Proton Experimental
1. Откройте свойства Dota 2 в Steam.
2. Перейдите в раздел «Совместимость».
3. Включите «Принудительно использовать определённый инструмент совместимости».
4. Выберите `Proton Experimental`.
5. Дождитесь окончания загрузки необходимых файлов.

### 2. Установка Workshop Tools
После загрузки файлов:
1. Откройте свойства Dota 2 в Steam.
2. Перейдите в раздел «DLC»
3. Установите **Dota 2 Workshop Tools DLC**.
4. Дождитесь окончания загрузки необходимых файлов.

### 3. Настройка параметров запуска
В свойствах добавьте параметры запуска: `-tools -addon main -language english -novid`

- `main` является названием аддона, который будет использоваться в Workshop Tools. Если нужно использовать другое название, замените `main` во всех дальнейших шагах.

### 4. Создание папки аддона
- Перейдите в: `Steam/steamapps/common/dota 2 beta/content/dota_addons`
- Создайте папку: `main`
- В эту папку помещаются необходимые исходные, то есть не скомпилированные файлы.

### 5. Подготовка скомпилированных файлов
- Перейдите в: `Steam/steamapps/common/dota 2 beta/game/dota_addons`
- Скопируйте папку: `template_addon`
- Переименуйте копию в: `main`
- Откройте созданную папку `main` и удалите все файлы, кроме: `addoninfo.txt`
В этой папке будут находиться скомпилированные файлы.

### 6. Запуск Workshop Tools
После выполнения всех шагов запустите Dota 2 через Steam.

Workshop Tools должны запуститься с аддоном `main`.

### Отключение Workshop Tools
Чтобы вернуться к обычному запуску Dota 2:

1. Откройте свойства Dota 2 в Steam.
2. Перейдите в раздел «Совместимость».
3. Отключите принудительное использование Proton Experimental.
4. Дождитесь завершения необходимых изменений.
5. Удалите из параметров запуска: `-tools -addon main -language english`


### Повторный запуск Workshop Tools
Чтобы снова использовать Workshop Tools, повторите шаги 1, 2 и 3 (ну и ебля...)
